...
export const CertifiedReviews = () => {
  ...
  useEffect(() => {
    ...
    }, 7000); // Plus lent pour voir l'effet 3D
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-6">
      ...
      <div className="perspective-1000">
        <div className="glass-effect rounded-3xl p-8 card-3d-enhanced hover:shadow-neon transition-all duration-700 transform-gpu">
