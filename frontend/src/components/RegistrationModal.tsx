        ...
        <div className="p-6 overflow-y-auto flex-grow">
          ...
          {!showEmailForm && !showLoginForm ? (
            ...
            <form onSubmit={handleEmailSignUp} className="space-y-4">
              ...
              <div><label className="block text-sm font-medium text-gray-200 mb-2">Adresse email</label><Input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required className="w-full bg-gray-800/50 border-gray-600 text-white placeholder-gray-400 focus:border-blue-400 focus:ring-blue-400/20" placeholder="votre@email.com" autoComplete="username"/></div>
